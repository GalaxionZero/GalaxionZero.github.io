<?php
    ...
    if (isset($_POST['username'])) {
        ...
        $checkQuery = "SELECT * FROM sensei WHERE username='$username' OR email='$email'";
        ...
        if ($result->num_rows > 0) {
            ...
            $query = "INSERT INTO sensei (username, password, email) VALUES ('$username', '$hashedPassword', '$email')";

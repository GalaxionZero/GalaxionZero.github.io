<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "SELECT * FROM sensei WHERE email='$email'";
        ...
        if ($data = mysqli_fetch_assoc($result)) {
            if (password_verify($password, $data['password'])) {
                ...
                if ($data['photo_address'] == NULL || $data['photo_address'] == "") {
                    $_SESSION['photo_address'] = "assets/sensei_default_profile.jpeg";
                } else {
                    $_SESSION['photo_address'] = "pfp_img/" . $data['photo_address'];
                }

                if ($data['email'] == 'zetayu24@gmail.com')
